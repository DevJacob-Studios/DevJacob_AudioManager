if IsDuplicityVersion() then
    exports("getAudioManagerObject", function(currentResource)
        currentResource = currentResource or GetCurrentResourceName()
        
        AudioManager = {}
        AudioManager._CurrentResource = currentResource
    ...
    exports("getAudioManagerObject", function(currentResource)
        ...
        function AudioManager.PlaySoundOnClient(soundFile, target, options)
            ...
            local _promise = promise.new()
            CallbackManager.TriggerServerCallback("DevJacob:AudioManager:Server:AddSound", function(soundId)
                _promise:resolve(soundId)
            end, {
                source = "onClient",
                data = {
